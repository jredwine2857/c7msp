...
6. Why C7 (`#why`) — 4-cell grid
7. CTA (`#contact`) — background video, call + email buttons
8. Footer — logos, links, client portals
...
* **Promo video pending:** a \~2:09 talking-head promo video is meant to be embedded (planned: click-to-play section between Flat-Fee and Why C7). The first uploaded copy was corrupt — only 7s of picture vs 2:09 of audio. Waiting on a clean re-export.
